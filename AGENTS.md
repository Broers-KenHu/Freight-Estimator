...
- InvoiceReader:
  ...
  - GST basis check on 2026-06-25: local `actual_freight` equals InvoiceReader `detail_amount_inc_gst` for 863,436 mapped rows; it must be labelled/displayed as Actual inc GST. ERP Est remains `ERP_EX_GST` and comparison uses `estimated_freight * 1.10`.
